...
examRouter.post("/", authenticate, authorize("instructor", "admin"), examController.create);
examRouter.put("/:id", authenticate, authorize("instructor", "admin"), examController.update);
examRouter.delete("/:id", authenticate, authorize("admin"), examController.delete);
examRouter.get("/instructor/mine", authenticate, authorize("instructor"), examController.getByInstructor);
